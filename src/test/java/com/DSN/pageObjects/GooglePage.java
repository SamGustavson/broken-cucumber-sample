...
public class GooglePage extends BasePage {
   // private static final String PATH_URL = "";
    ...
    public void searchFor (String searchPattern){
        ...
        searchField.sendKeys((CharSequence) searchPattern);
        searchField.sendKeys(Keys.ENTER);
    }

    public WebElement searchResultItem(int searchResultItemNum){
        return Browser.get().findElement(By.xpath(String.format(String.valueOf(SEARCH_RESULT_LOCATOR), searchResultItemNum)));
    }
    ...
    public boolean isResultProvided (){
        return Browser.hasElement(By.xpath(String.format(String.valueOf(SEARCH_RESULT_LOCATOR), 1)));
    }
}
